// var EventEmitter=require("events").EventEmitter;                                how to get sample.txt in the folder

// var path=require("path");
// var filePath=path.join(__dirname,"sample1.txt")
// var filePath=__dirname + "/sample1.txt"
